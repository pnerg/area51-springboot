...
object Dependencies extends AutoPlugin {
  ...
  object autoImport {
    /** these exclusions apply to all libraries/dependencies */
    val `global-excludes` = Seq(
      ExclusionRule(organization = "org.springframework.boot", name="spring-boot-starter-tomcat" ) //exclude Tomcat as we use Jetty
    )
    ...
    val `spring-boot-starter-jetty` = "org.springframework.boot" % "spring-boot-starter-jetty" % springBootVersion
